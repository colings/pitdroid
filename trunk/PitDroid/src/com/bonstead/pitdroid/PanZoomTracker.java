...
public class PanZoomTracker {
    ...
    /*
     * Convenience class for storing min and max of a range
     * Value of the class is the delta between min and max
     */
    public static class Range<T extends Number> {
      ...
      public int   intValue()    { return max.intValue() - min.intValue(); }
      public float floatValue()  { return max.floatValue() - min.floatValue(); }
